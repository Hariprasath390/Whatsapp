...
function Header() {
  return (
    <div>
      ...
      <header className="flex items-center justify-between p-4 bg-[#e9edef] w-[430.5px] h-[59px] border-r border-gray-300">
          <div
            data-tab="2"
            tabindex="-1"
            role="button"
          ...
          >
            <img
              src="https://media-maa2-2.cdn.whatsapp.net/v/t61.24694-24/396796565_1343926299848404_7923830354994501364_n.jpg?stp=dst-jpg_s96x96&amp;ccb=11-4&amp;oh=01_AdQ7zY571zFcKVGLMBJwdu94JxDM_hXaMoXDtMYrUa_iWg&amp;oe=657A85CE&amp;_nc_sid=e6ed6c&amp;_nc_cat=103"
              alt=""
              draggable="false"
