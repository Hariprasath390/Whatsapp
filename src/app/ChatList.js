...
const ChatMessage = ({ imageUrl, phoneNumber, message, time, onClick }) => (
  <div
    className="flex w-[430.5px] h-[72px] bg-[#ffffff] mt-[0.5px] border-b border-gray-100"
    onClick={() => {
...
const ChatList = () => {
  ...
  return (
    <div className="flex  w-full  ">
      <div>
        <Header />
        <div className="flex items-center md:justify-evenly  space-x-2 w-[430.5px]  h-[49px] bg-white  mb-[0.5px] ">
          <button
      ...
      {selectedChat ? (
          ...
          <div className="">
            ...
            >
              <div className="  flex justify-end pr-14 pb-2">
                ...
                <div className="p-0 s8B">
                  <svg
                    viewBox="0 0 8 13"
                    height="13"
                    width="8"
                    className="fill-current text-[#c5e6c1] -mx-[1.9px]"
                  >
        ...
        <div className="bg-[#e9edef] w-full hidden md:block ">
          <div className="flex flex-col items-center pt-52">
            ...
            <div className="mt-4">
              <div className="text-3xl   font-extralight text-center text-[#667781] text-[20px]">
                WhatsApp Web
              </div>
              <div className="text-[10px] mt-2 text-center font-sans text-[#667781]">
            ...
            <div className="mt-4  flex justify-center items-center text-[10px] text-[#667781] pt-48  ">
              <span className="mr-2">
                <svg
                  viewBox="0 0 10 12"
                  height="12"
